...
if (selectedTheme) {
  //if the validate is fullfill we ask what the issue was to know if we activated or deactivateed the dark
...
//activate and deactivate the theme mannually with the button
themeButton.addEventListener("click", () => {
  //add or remove the dar/ icon theme
